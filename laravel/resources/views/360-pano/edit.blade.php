...
@section ('navigation-link')
    ...
    <p class="left">Bewerk 360° panorama omgeving</p>
@endsection
...
<main>
    ...
    <!-- Foms -->
    <div class="container">
        <form method="POST" action="{{ route('360-pano.update', ['id' => $space->id ]) }}"  enctype='multipart/form-data'>     
            {{ csrf_field() }}
            {{ method_field('PUT')}}            
                    ...
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <label class="btn-upload center-block">
                            <div class="pano-preview">
                                <img src="{{ asset($pano[0]->value) }}" id="pano-img-output" />
                                <i class="material-icons">camera_alt</i>
                            </div>
