...
<p class="left">Bewerk 360° tijdlijn omgeving</p>
@endsection
...
<main>
    ...
    <!-- Form -->
    <div class="container">
        <form method="POST" action="{{ route('360-timeline.update', ['id' => $space->id ]) }}"  enctype='multipart/form-data'>
            {{ csrf_field() }}
            {{ method_field('PUT')}} 
            ...
            <div id="step2" class="col s12">
                ...
                <div class="row center-align">
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <div class="info">
                            <p>Bepaal het aantal mijlpalen in de tijdlijn<br>door een cijfer te kiezen.</p>
                        </div>
                    </div>
                </div>
                <div class="row center-align">
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <p>
                            <label>
                                @if (count($slides) >= 2 )
                                <input class="with-gap" id='slides_2' name="slides" type="radio" value="2" checked/><span>2 Mijlpalen</span>
                                @else 
                                <input class="with-gap" id='slides_2' name="slides" type="radio" value="2"/><span>2 Mijlpalen</span>
                                @endif
                            </label>
                        </p>
                        <p>
                            <label>
                                @if (count($slides) >= 3 )
                                <input class="with-gap" id='slides_3' name="slides" type="radio" value="3" checked/><span>3 Mijlpalen</span>
                                @else 
                                <input class="with-gap" id='slides_3' name="slides" type="radio" value="3"/><span>3 Mijlpalen</span>
                                @endif
                            </label>
                        </p>
                        <p>
                            <label>
                                @if (count($slides) >= 4 )
                                <input class="with-gap" id='slides_4' name="slides" type="radio" value="4" checked/><span>4 Mijlpalen</span>
                                @else 
                                <input class="with-gap" id='slides_4' name="slides" type="radio" value="4"/><span>4 Mijlpalen</span>
                                @endif
                            </label>
                        </p>
                        <p>
                            <label>
                                @if (count($slides) >= 5 )
                                <input class="with-gap" id='slides_5' name="slides" type="radio" value="5" checked/><span>5 Mijlpalen</span>
                                @else 
                                <input class="with-gap" id='slides_5' name="slides" type="radio" value="5"/><span>5 Mijlpalen</span>
                                @endif
                            </label>
                        </p>
                        <p>
                            <label>
                                @if (count($slides) >= 6 )
                                <input class="with-gap" id='slides_6' name="slides" type="radio" value="6" checked/><span>6 Mijlpalen</span>
                                @else 
                                <input class="with-gap" id='slides_6' name="slides" type="radio" value="6"/><span>6 Mijlpalen</span>
                                @endif
                            </label>
                        </p>
                    </div>
                    ...
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <div class="title-bar">
                            <h1>
                                ...
                                Voeg afbeeldingen toe aan de tijdlijn
                            </h1>
                        </div>
                    </div>
                </div>
