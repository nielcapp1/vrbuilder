...
<main>
    ...
    <!-- Form -->
    <div class="container">
        <form method="POST" action="{{ route('360-slider.update', ['id' => $space->id ]) }}"  enctype='multipart/form-data'>      
            {{ csrf_field() }}
            {{ method_field('PUT')}} 
                    ...
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <p>
                            <label>
                                ...
                                @else 
                                <input class="with-gap" id='slides_2' name="slides" type="radio" value="2"/><span>2 Slides</span>
                                @endif
                            </label>
                        </p>
                        <p>
                            <label>
                                @if (count($slides) >= 3 )
                                <input class="with-gap" id='slides_3' name="slides" type="radio" value="3" checked/><span>3 Slides</span>
                                @else 
                        ...
                        <p>
                            <label>
                                @if (count($slides) >= 4 )
                                <input class="with-gap" id='slides_4' name="slides" type="radio" value="4" checked/><span>4 Slides</span>
                                @else 
                        ...
                        <p>
                            <label>
                                @if (count($slides) >= 5 )
                                <input class="with-gap" id='slides_5' name="slides" type="radio" value="5" checked/><span>5 Slides</span>
                                @else 
                        ...
                        <p>
                            <label>
                                @if (count($slides) >= 6 )
                                <input class="with-gap" id='slides_6' name="slides" type="radio" value="6" checked/><span>6 Slides</span>
                                @else 
