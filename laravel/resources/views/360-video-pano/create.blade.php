...
<p class="left">Voeg 360° video omgeving toe</p>
@endsection
...
<main>
    ...
    <!-- Foms -->
    <div class="container">
        <form method="POST" action="{{ url('/360-video-pano/store') }}" enctype='multipart/form-data'>
            {{ csrf_field() }}
                    ...
                    <div class="col l6 m8 s12 offset-l3 offset-m2">
                        <label class="btn-upload center-block">
                            <div class="video-pano-preview">
                                ...
                                <video src="" id="video-pano-output" loop autoplay></video>
                            </div>
                            {{-- <video src="" id="video-pano-output" controls autoplay></video> --}}
